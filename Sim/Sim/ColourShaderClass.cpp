...
bool ColourShaderClass::Initialise(ID3D11Device* device, HWND hwnd)
{
	...
	WCHAR vs[] = L"../Sim/Color.vs";
	WCHAR ps[] = L"../Sim/Color.ps";
...
bool ColourShaderClass::Renderer(ID3D11DeviceContext* deviceContext, int indexCount, XMMATRIX worldMatrix, XMMATRIX viewMatrix,
